# Ajile Management Tool

Ajile Management Tool is a **web-based management application** built with **Angular** and **Tailwind CSS**. It provides a workspace for managing work items, projects, tasks, and employee timesheets.

![Ajile Management Tool](./angular-tailwind.png)
...
Ajile Management Tool uses the **Angular** ecosystem, **TypeScript**, and the utility-first styling of **Tailwind CSS v4**.

Ajile Management Tool is built on:

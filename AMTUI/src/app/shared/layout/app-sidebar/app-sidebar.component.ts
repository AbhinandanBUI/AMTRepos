...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    // },
    {
      ...
      subItems: [
        { name: "Board", path: "/workitems/boards", pro: false },
        { name: "Backlog", path: "/workitems/backlogs", pro: false },
        { name: "Work Item", path: "/workitems/work-items", pro: false },
        { name: "Sprint", path: "/workitems/sprints", pro: false },
        { name: "My Query", path: "/workitems/my-query", pro: false },
        { name: "Create Work Item", path: "/workitems/work-item-create", pro: false },
    ...
    },
    {
      ...
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C11.5858 2 11.25 2.33579 11.25 2.75V12C11.25 12.4142 11.5858 12.75 12 12.75H21.25C21.6642 12.75 22 12.4142 22 12C22 6.47715 17.5228 2 12 2ZM12.75 11.25V3.53263C13.2645 3.57761 13.7659 3.66843 14.25 3.80098V3.80099C15.6929 4.19606 16.9827 4.96184 18.0104 5.98959C19.0382 7.01734 19.8039 8.30707 20.199 9.75C20.3316 10.2341 20.4224 10.7355 20.4674 11.25H12.75Z" fill="currentColor"></path></svg>`,
      subItems: [
        { name: "Timesheet Overview", path: "/timesheet/overview", pro: false },
        { name: "Fill Timesheet", path: "/timesheet/fill", pro: false },
        { name: "Assign Project", path: "/timesheet/assign-project", pro: false },
        { name: "Add Tasks", path: "/timesheet/add-tasks", pro: false },
      ]
    },
    {
      name: "Settings",
  ...
  constructor(
    ...
    this.navItems.find((item) => item.name === 'Home')!.icon =
      '<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 11.5 12 4l9 7.5V20a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1v-8.5Z" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 21v-6h6v6" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/></svg>';
    this.navItems.find((item) => item.name === 'Timesheet')!.icon =
      '<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="3" width="16" height="18" rx="2" stroke="currentColor" stroke-width="1.7"/><path d="M8 2v3M16 2v3M4 9h16M8 13h3M8 17h5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/><circle cx="16.5" cy="15.5" r="2.5" stroke="currentColor" stroke-width="1.7"/><path d="M16.5 14v1.7l1 0.6" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>';
    this.navItems.find((item) => item.name === 'Settings')!.icon =
      '<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.7 3.5 10.4 2h3.2l.7 1.5 1.8.8 1.6-.4 2.3 2.3-.4 1.6.8 1.8 1.5.7v3.2l-1.5.7-.8 1.8.4 1.6-2.3 2.3-1.6-.4-1.8.8-.7 1.5h-3.2l-.7-1.5-1.8-.8-1.6.4-2.3-2.3.4-1.6-.8-1.8-1.5-.7V10l1.5-.7.8-1.8-.4-1.6 2.3-2.3 1.6.4 1.8-.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.7"/></svg>';
  }

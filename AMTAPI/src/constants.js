...
export const UserRolesEnum = {
  ...
  export const DB_NAME = "devAMTDB";
  //  const MONGOURI = "mongodb+srv://pgmanagement:pgdbmanagement@cluster0.xj3aocc.mongodb.net/DevEwallet2?retryWrites=true&w=majority";

  // export const DB_NAME = "pgmanagement:abhinandansingh@cluster0.xj3aocc.mongodb.net/dbrewallet?retryWrites=true&w=majority";


  //mongodb+srv://<username>:<password>@cluster0.xj3aocc.mongodb.net/
